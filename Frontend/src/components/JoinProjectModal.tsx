        ...
        <form onSubmit={handleJoin} className="p-5 space-y-4">
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1">
              Code d’invitation reçu de l’administrateur
            </label>
            <input
              type="text"
              required
              placeholder="Ex: MJ-LINEAR-2025-X89K"
              value={token}
          ...
          <p className="text-[11px] text-slate-500 leading-relaxed">
            Astuce démo : Vous pouvez utiliser le code d'invitation de démo{' '}
            <button
              type="button"
              onClick={() => setToken('MJ-LINEAR-2025-X89K')}
              className="text-indigo-600 font-mono font-bold underline"
            >
              MJ-LINEAR-2025-X89K
            </button>{' '}
            ou en générer un nouveau depuis l'onglet Membres d'un projet.
          </p>
